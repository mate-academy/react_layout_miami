...
import person__1 from '../../images/person__1.jpg';
import person__2 from '../../images/person__2.jpg';
import person__3 from '../../images/person__3.jpg';
      ...
      <div className="container container--testimonials">
        ...
        <div className="testis">
          ...
          <div className="t">
            ...
            <div className="t__description">
              <p>
                My soul is illuminated by an unearthly joy, as these beautiful spring morning, which I enjoy with
                all my heart. I\'m all alone and blissfully happy in the local edge. as if created for the likes of me.
              </p>
            </div>
          </div>
          <div className="t">
