    ...
    <section className="section best">
      <div className="container container--best">
        <div className="best__motto">
          Miami
          <span className="best__motto-text--best"> best</span>
          <br />
          Realty
          <span className="best__motto-text--this">—
            <br />
            this
          </span>
        </div>
        <div className="best__text">
          <p>
            <span className="best__text--strong">Over 50 years experience in love.</span>
            <br />
          ...
          <p>
            <span className="best__text--strong">We will never late!
              <br />
