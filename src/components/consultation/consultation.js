    ...
    <section className="section consultation">
      <div className="container container--consultation">
        ...
        <div className="consultation__info">
          <h2 className="consultation__title">How long have
            <br />
          ...
          <p className="consultation__text">The procedural change mezzo forte starts izoritmichesky pickup at these
            moments stop LA Mazel and VA Tsukkerman in his "Analysis of musical works." Pointillism, which originated in the
            music of the early twentieth century, microforms, found a distant historical
          </p>
        </div>
