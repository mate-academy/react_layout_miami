      ...
      <div className="hero">
        <div className="container container--hero">
          ...
          <ul className="nav">
            ...
            <li className="nav__item"><a className="nav__link" href="#">gallery</a></li>
            <li className="nav__item"><a className="nav__link" href="#">consultation</a></li>
            <li className="nav__item"><a className="nav__link" href="#">testimonials</a></li>
            <li className="nav__item"><a className="nav__link" href="#">Contacts</a></li>
          </ul>
        </div>
      </div>
  );
